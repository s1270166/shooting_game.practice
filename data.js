...
let tekiMaster=[
  ...
  new TekiMaster( 2, 70, 5000, 10000), //1,ボスきいろひよこ
  new TekiMaster( 3, 10, 1, 10), //1,ボスきいろひよこのこども
]
...
let sprite = [
  new Sprite( 0,0,22,42 ),  //0 ,一番左
  new Sprite( 23,0,33,42 ), //1 ,左
  new Sprite( 57,0,43,42 ), //2 ,真ん中
  new Sprite( 101,0,33,42 ),//3 ,右
  new Sprite( 135,0,21,42 ),//4 ,一番右
